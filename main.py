...
def demo(myaqua):
    ...
    for i in range(120):
        ....
    """
    myaqua.add_animal("scalarfish1", 100, 10, 10, 1, 0, 'sc')
    myaqua.add_animal("molyfish2", 12, 35, 15, 0, 1, 'mo')
    myaqua.add_animal("shrimpcrab1", 3, 10, myaqua.aqua_height, 1, 0, 'sh')
    myaqua.add_animal("ocypodecrab2", 13, 39, myaqua.aqua_height, 0, 0, 'oc')
    myaqua.feed_all()
